     ...
     <div class="container-fluid">
	    	...
	    	<div class="row">
                    <div class="col-md-3 ">
                       ...
                       <p><font size="1">VENTE ET DOCUMENTATION</font><br>
                        <font size="1">TECHNIQUE</font></p>
                         
                        
                    </div>
                    <div class="col-md-5 mt-5 ">
	                    <div class="row text-center">
	                            <h2 class=" font-weight-bold deep-orange-lighter-hover mb-3 blue-grey-text">RÉGIE DE LA CARTOGRAPHIE</h2>
	                    </div>
                	</div>
            </div>
